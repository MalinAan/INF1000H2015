public class Mainmetode{
  public static void main(String [] args) throws Exception{
    ...
    System.out.println("Finnes kantarellsuppe i oppskriftsboken? " + oppskriftsboken.finnesOppskrift("Kantarellsuppe"));

    //Sjekker om "Tomatsuppe" finnes - burde returnere false.
    System.out.println("Finnes tomatsuppe i oppskriften?" + oppskriftsboken.finnesOppskrift("Tomatsuppe"));
  }
}
